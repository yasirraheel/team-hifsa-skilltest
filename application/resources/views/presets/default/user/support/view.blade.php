...
@section('content')
    ...
    @endif
    <div class="mt-5 container {{ auth()->user() ? '' : 'mb-5' }}">
        <div class="row justify-content-center gy-4">
            <div class="{{ auth()->user() ? 'col-xl-12 col-lg-12' : 'col-lg-12 mt-4' }}">
                <div class="base--card">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input--group textarea">
                                                <textarea id="message" class="form--control" name="message" placeholder="@lang('Please enter your Message')">{{ old('message') }} </textarea>
                                            </div>
                                        </div>
                                    </div>
