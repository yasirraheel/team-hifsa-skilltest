                    ...
                    <div class="account-form base--card mt-5">
                        <div class="verification-code-wrapper">
                            <div class="verification-area">
                                ...
                                <form action="{{ route('instructor.password.verify.code') }}" method="POST" class="submit-form">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="{{ route('instructor.password.request') }}" class="text--base">@lang('Try to send again')</a>
                                    </div>
                                </form>
                            </div>
                        </div>
