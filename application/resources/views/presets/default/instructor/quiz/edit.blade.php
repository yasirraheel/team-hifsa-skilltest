                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form--control" name="name" value="{{ $quiz->name ??old('name') }}"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form--control" name="time"
                                        value="{{ @$quiz->time ?? old('time') }}" placeholder="Time" required>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form--control" name="pass_mark"
                                        value="{{ @$quiz->pass_mark ?? old('pass_mark') }}" placeholder="Pass Mark"
                                        required>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form--control" name="total_question"
                                        value="{{ @$quiz->total_question ?? old('total_question') }}"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form--control form-select" name="active_quiz" id="active_quiz" required>
                                        ...
                                        <option value="1" {{ @$quiz->active_quiz == 1 ? 'selected' : '' }}>
                                            @lang('Active')</option>
                                        <option value="0" {{ @$quiz->active_quiz == 0 ? 'selected' : '' }}>
                                            @lang('Pending')</option>
                                    </select>
                                </div>
                            </div>
