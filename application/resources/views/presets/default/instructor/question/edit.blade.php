...
@section('content')
    ...
    <div class="row justify-content-center mx-lg-0">
        <div class="col-lg-12 justify-content-center">
            <div class="base--card">
                <div class="col-lg-12">
                    <form action="{{ route('instructor.question.update', [$question->id, $quiz->id]) }}" method="POST"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form--control" type="number" name="mark"
                                                value="{{ $question->mark ?? old('mark') }}" placeholder="Mark" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="row elements global-card mt-4 align-items-center">
                                                <div class="col-sm-8 my-3">
                                                    <div class="file-upload input-group">
                                                        <input type="text" name="options[]" id="inputOptions"
                                                            class="form-control form--control" placeholder="Options Name" value="{{$item}}"
                                                            required />
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-check">
                                                        <input class="form-check-input correct-answer-input" type="checkbox" value="{{$index}}"
                                                            id="flexCheckChecked" {{ in_array((int) $index, $selectedCorrectAnswers, true) ? 'checked' : '' }} name="correct_answer[]">
                                                        <label class="form-check-label" for="flexCheckChecked">
                                                            @lang('Correct Answer')
                                                        </label>
                                                    </div>
