                                ...
                                <div class="drop-file-wrap--">
                                    <div class="dashboard_profile_wrap">
                                        <div class="profile_photo mb-2">
                                            <img id="imgPre"
                                                src="{{ getImage(getFilePath('instructorProfile') . '/' . auth('instructor')->user()?->image, getFileSize('userProfile')) }}"
                                                alt="instructor">
                                        ...
                                        <div class="user-info text-center">
                                            <p><span>@lang('User Name'):</span>{{ auth('instructor')->user()->fullname ?? auth('instructor')->user()->username }}
                                            </p>
                                            <p><span>@lang('Email'):</span>{{ auth('instructor')->user()->email }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        (function($) {
            ...
            $('.checkUser').on('focusout', function(e) {
                var url = '{{ route('instructor.checkUser') }}';
                var value = $(this).val();
