    ...
    <div class="row mx-lg-0 mb-3">
        <div class="col-lg-12">
            <div class="filter-wrap">
                ...
                <a href="{{ route('instructor.ticket.open') }}" class="btn btn--base">
                        ...
                        @forelse($supports as $support)
                            <tr>
                                ...
                                <td data-label="Subject" class="text-center">
                                    <a href="{{ route('instructor.ticket.view', $support->ticket) }}" class="fw-bold text-black">
                                ...
                                <td data-label="Action" class="text-center">
                                    <a class="btn btn--sm"
                                        href="{{ route('instructor.ticket.view', $support->ticket) }}">@lang('View')
                                    </a>
                                </td>
                            </tr>
                        @empty
