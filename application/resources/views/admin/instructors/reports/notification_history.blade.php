                    ...
                    <table class="table table--light style--two">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    @if($log->instructor)
                                    <a href="{{ route('admin.instructors.detail', $log->instructor_id) }}">{{ @$log->instructor->fullname
                                        }}</a>
                                    @else
                                ...
                                <td>
                                    <button title="@lang('Details')" class="btn btn-sm btn--primary notifyDetail"
                                        ...
                                        'email') data-message="{{ route('admin.instructor.report.email.details',$log->id)}}" @else
...
@if(@$user)
<a href="{{ route('admin.instructors.notification.single',$user->id) }}" class="btn btn--primary btn-sm"><i
