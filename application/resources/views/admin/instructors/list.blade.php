...
@section('panel')
    @include('admin.components.tabs.instructor')
    <div class="row">
        <div class="col-lg-12">
                        ...
                        <table class="table table--light style--two">
                            ...
                            <tbody>
                                @forelse($users as $user)
                                    <tr>
                                        <td>
                                            <a href="{{ route('admin.instructors.detail', $user->id) }}">{{ $user->fullname }}
                                                ({{ $user->username }})
                                            </a>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            @if (Request::routeIs('admin.instructors.kyc.pending'))
                                                <a title="@lang('Kyc Details')"
                                                    href="{{ route('admin.instructors.kyc.details', $user->id) }}"
                                            ...
                                            <a title="@lang('User Profile')"
                                                href="{{ route('admin.instructors.detail', $user->id) }}"
                                                class="btn btn-sm btn--primary">
