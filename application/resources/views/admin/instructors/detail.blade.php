            ...
            <div class="row">
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center m-b-0">
                                            <div class="col">
                                                ...
                                                <h3 class="m-b-0">
                                                    {{ $general->cur_sym }}{{ showAmount($totalWithdrawals) }}</h3>
                                            </div>
                                            <div class="col-auto">
                ...
                <div class="col-xl-8">
                    <div class="card">
                            ...
                            <ul class="d-flex flex-wrap gap-1">
                                ...
                                <li class="flex-grow-1 flex-shrink-0">
                                    <a class="d-block btn bg--primary"
                                        href="{{ route('admin.instructors.login', $user->id) }}" target="_blank">
                                        <i class="las la-sign-in-alt"></i> @lang('Login as instructor')
                                    </a>
                                </li>
                                <li class="flex-grow-1 flex-shrink-0">
                                    <a class="d-block btn bg--primary"
                                        href="{{ route('admin.instructors.notification.log', $user->id) }}">
                                ...
                                <li class="flex-grow-1 flex-shrink-0">
                                    <a class="d-block btn bg--primary"
                                        href="{{ route('admin.instructors.notification.single', $user->id) }}">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.instructors.update', [$user->id]) }}" method="POST"
    ...
    <div id="addSubModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.instructors.add.sub.balance', $user->id) }}" method="POST">
                    @csrf
    ...
    <div id="userStatusModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.instructors.status', $user->id) }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        @if ($user->status == 1)
