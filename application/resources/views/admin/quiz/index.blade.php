...
@push('breadcrumb-plugins')
    <div class="d-flex flex-wrap justify-content-end align-items-center">
        <a href="{{ route('admin.quiz.create') }}" class="btn btn-sm btn--primary create_course_category me-3"><i
