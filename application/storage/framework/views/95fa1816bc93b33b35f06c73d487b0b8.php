...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row justify-content-center mx-lg-0">
        <div class="col-lg-12 justify-content-center">
            <div class="base--card">
                <div class="text-end">
                    <a href="<?php echo e(route('ticket')); ?>" class="btn btn--base btn-sm mb-2"><?php echo app('translator')->get('My Support Ticket'); ?></a>
                </div>
                    ...
                    <form action="<?php echo e(route('ticket.store')); ?>" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-sm-12 text-end">
                                <button type="button" class="btn btn--sm btn--base ms-2 addFile">
                            ...
                            <div class="col-lg-12">
                                <div class="attachment_wrapper mb-4">
                                    <div class="form-group profile mb-15">
                                        ...
                                        <p class="ticket-attachments-message text-muted "> <?php echo app('translator')->get('Allowed File Extensions'); ?>: <span
...
<?php echo $__env->make($activeTemplate . 'layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\team-hifsa-skilset\application\resources\views\presets\default\user\support\create.blade.php ENDPATH**/ ?>