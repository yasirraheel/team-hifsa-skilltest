                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="payment-method-item block-item card border--primary border--primary">
                            <h5 class="card-header bg--primary"><?php echo app('translator')->get('Gateway Settings for'); ?> <?php echo e(__($gateway->name)); ?></h5>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" value="<?php echo e(route($param->value)); ?>"
                                                    readonly />
                        ...
                        <?php if(isset($gateway->currencies)): ?>
                            <?php $__currentLoopData = $gateway->currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gatewayCurrency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="card border--primary <?php echo e($loop->index == 0 ? 'mt-5' : ''); ?> mb-4">
        
                                    <div class="card-header bg--primary">
                                        <div class="content w-100 ps-0">
                                            <div class="d-flex justify-content-between">
                                                <div class="form-group">
                                                    <h4 class="bg--primary"><?php echo e(__($gateway->name)); ?> - <?php echo e(__($gatewayCurrency->currency)); ?>
                                                ...
                                                <div class="remove-btn">
                                                    <button title="<?php echo app('translator')->get('Remove'); ?>" type="button"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <input type="number" step="any" class="form-control"
                                                                            ...
                                                                            required />
                                                                        <div class="input-group-text bg--primary"><?php echo e(__($general->cur_text)); ?></div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                        ...
                                                        <div class="mt-2">
                                                            <div class="">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="currency[<?php echo e($currencyIndex); ?>][symbol]"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <div class="input-group-text bg--primary">1 <?php echo e(__($general->cur_text)); ?> =</div>
                                                                        <input type="number" step="any" class="form-control"
                                                                            name="currency[<?php echo e($currencyIndex); ?>][rate]"
                                                                            value="<?php echo e(getAmount($gatewayCurrency->rate)); ?>" required />
                                                                        <div class="input-group-text bg--primary"><span
                                                                                class="currency_symbol text-white"><?php echo e(__($gatewayCurrency->baseSymbol())); ?></span></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control"
                                                                                ...
                                                                                value="<?php echo e($globalParameters->$key); ?>" required />
                                                                        </div>
                                                                    </div>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </div>
                        ...
                        <div class="card border--primary mt-5 newMethodCurrency d-none">
                            <h5 class="card-header bg--primary"><?php echo app('translator')->get('Currency Configuration'); ?></h5>
                            <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <div class="form-group">
                                                    ...
                                                    <input disabled type="hidden" class="form-control"
                                                        name="currency[<?php echo e($currencyIndex); ?>][name]" id="payment_currency_name_input" required />
                                                </div>
                                                <div class="remove-btn">
                                                    <button title="<?php echo app('translator')->get('Remove'); ?>" type="button"
                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <div class="input-group-text bg--primary"><?php echo e(__($general->cur_text)); ?></div>
                                                        <input disabled type="number" step="any" class="form-control"
                                                            name="currency[<?php echo e($currencyIndex); ?>][fixed_charge]" required />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <div class="input-group-text bg--primary">%</div>
                                                        <input disabled type="number" step="any" class="form-control"
                                                            name="currency[<?php echo e($currencyIndex); ?>][percent_charge]" required>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input disabled type="step"
                                                                ...
                                                                name="currency[<?php echo e($currencyIndex); ?>][currency]" readonly />
                                                        </div>
                                                    </div>
...
<?php $__env->stopSection(); ?>
    ...
    <?php $__env->startPush('breadcrumb-plugins'); ?>
        <a href="<?php echo e(route('admin.gateway.automatic.index')); ?>" class="btn btn-sm btn--primary"><i class="la la-undo"></i><?php echo app('translator')->get('Back'); ?></a>
    <?php $__env->stopPush(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\team-hifsa-skilset\application\resources\views\admin\gateways\automatic\edit.blade.php ENDPATH**/ ?>