                    ...
                    <div class="verification-area base--card mt-5">
                        ...
                        <form action="<?php echo e(route('user.verify.mobile')); ?>" method="POST" class="submit-form">
                            ...
                            <div class="form-group">
                                <p>
                                    <?php echo app('translator')->get('If you don\'t get any code'); ?>, <a href="<?php echo e(route('user.send.verify.code', 'phone')); ?>"
...
<?php echo $__env->make($activeTemplate . 'layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\team-hifsa-skilset\application\resources\views\presets\default\user\auth\authorization\sms.blade.php ENDPATH**/ ?>