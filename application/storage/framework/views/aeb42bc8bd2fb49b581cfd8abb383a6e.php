...
<?php $__env->startSection('content'); ?>
    <div class="row justify-content-center gy-4">
        <div class="col-lg-6">
            <div class="base--card">
                <form action="<?php echo e(route('instructor.withdraw.money')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    <h5 class="mb-4"> <?php echo app('translator')->get('Your Current Balance:'); ?> <?php echo e($general->cur_sym); ?><?php echo e(showAmount(auth('instructor')->user()->balance)); ?></h5>
                    <div class="dashboard-card-wrap">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="input-group">
                                <input type="number" step="any" name="amount" value="<?php echo e(old('amount')); ?>"
                                    class="form-control form--control" required>
                                <span class="input-group-text bg--base border-0"><?php echo e($general->cur_text); ?></span>
                            </div>
                        </div>
...
<?php echo $__env->make($activeTemplate . 'instructor.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\team-hifsa-skilset\application\resources\views\presets\default\instructor\withdraw\methods.blade.php ENDPATH**/ ?>