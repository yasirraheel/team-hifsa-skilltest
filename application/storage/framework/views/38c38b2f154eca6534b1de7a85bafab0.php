...
<?php $__env->startSection('content'); ?>
        ...
        <div class="dash-box">
            <div class="row">
                <div class="col-lg-6 my-auto">
                    <h2 class="mb-0"><?php echo app('translator')->get('Welcome Back'); ?><span> <?php echo e(auth('instructor')->user()->fullname ?? auth('instructor')->user()->username); ?>?</span></h2>
                </div>
    ...
    <div class="row gy-4 mx-lg-0">
        <div class="col-xxl-3 col-xl-4 col-lg-6 col-sm-6">
            <a class="d-block" href="<?php echo e(route('instructor.home')); ?>">
                <div class="dashboard-card">
                    ...
                    <div class="dashboard-card__content">
                        <h5 class="dashboard-card__amount">
                            <?php echo e($general->cur_sym . showAmount(auth('instructor')->user()->balance)); ?></h5>
                        <h5 class="dashboard-card__title"><?php echo app('translator')->get('Your Balance'); ?></h5>
                    </div>
        ...
        <div class="col-xxl-3 col-xl-4 col-lg-6 col-sm-6">
            <a class="d-block" href="<?php echo e(route('instructor.course.index')); ?>">
                <div class="dashboard-card">
                    <div class="card-shape">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                            <path fill-opacity="1"
                    ...
                    <div class="dashboard-card__content">
                        <h5 class="dashboard-card__amount"><?php echo e($totalCourses); ?></h5>
                        <h5 class="dashboard-card__title"><?php echo app('translator')->get('Total Course'); ?></h5>
                    </div>
                    <div class="dashboard-card__icon">
        ...
        <div class="col-xxl-3 col-xl-4 col-lg-6 col-sm-6">
            <a class="d-block" href="<?php echo e(route('instructor.course.index')); ?>">
                <div class="dashboard-card">
                    ...
                    <div class="dashboard-card__content">
                        <h5 class="dashboard-card__amount"><?php echo e($enrollCount); ?></h5>
                        <h5 class="dashboard-card__title"><?php echo app('translator')->get('Total Enrolls'); ?></h5>
                    </div>
                    <div class="dashboard-card__icon">
        ...
        <div class="col-xxl-3 col-xl-4 col-lg-6 col-sm-6">
            <a class="d-block" href="<?php echo e(route('ticket.open')); ?>">
                <div class="dashboard-card">
                    ...
                    <div class="dashboard-card__content">
                        <h5 class="dashboard-card__amount"><?php echo e($ticket->instructorOpen()->count()); ?></h5>
        ...
        (function() {
            var options = {
                ...
                series: [{
                    ...
                    name: '<?php echo app('translator')->get('Withdrawls'); ?>',
                    type: 'area',
                    data: <?php echo json_encode($withdrawChart['values'], 15, 512) ?>
                }],
                fill: {
                    opacity: [0.85, 1],
                },
...
<?php echo $__env->make($activeTemplate . 'instructor.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\team-hifsa-skilset\application\resources\views\presets\default\instructor\dashboard.blade.php ENDPATH**/ ?>