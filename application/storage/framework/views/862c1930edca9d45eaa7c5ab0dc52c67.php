...
<?php $__env->startSection('content'); ?>
    <div class="row justify-content-center mx-lg-0">
        <div class="col-lg-12 justify-content-center">
            <div class="base--card">
                <div class="col-lg-12">
                    <form action="<?php echo e(route('instructor.lesson.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-xl-6">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form--control form-select" name="status" id="status" required>
                                        <option value=""><?php echo app('translator')->get('Select One'); ?></option>
                                        <option value="1" <?php echo e(@$lesson->status == 1 ? 'selected' : old('status')); ?>>
                                            <?php echo app('translator')->get('Active'); ?></option>
                                        <option value="0"<?php echo e(@$lesson->status == 0 ? 'selected' : old('status')); ?>>
                ...
                <div class="row justify-content-end text-end">
                    <div class="col-4 mt-4">
                        <button type="submit" class="btn btn--base"><?php echo app('translator')->get('Save'); ?></button>
                    </div>
                </div>
                </form>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p><?php echo app('translator')->get('Are you sure? You delete upload video?'); ?></p>
...
<?php $__env->startPush('script'); ?>
    ...
    <script type="text/javascript">
        ...
        let resumable = new Resumable({
            target: '<?php echo e(route('instructor.lesson.video.upload')); ?>',
            query: {
    ...
    <script>
        ...
        function uploadeVideoDeleteAjax(ancor, srcValue, fileName) {
            $.ajax({
                url: "<?php echo e(route('instructor.lesson.video.upload.delete')); ?>",
                type: "POST",
                data: {
                    videoUrl: srcValue,
                    fileName: fileName,
...
<?php echo $__env->make($activeTemplate . 'instructor.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\team-hifsa-skilset\application\resources\views\presets\default\instructor\lessons\create.blade.php ENDPATH**/ ?>