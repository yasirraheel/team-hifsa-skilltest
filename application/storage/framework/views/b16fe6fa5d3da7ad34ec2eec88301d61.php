        ...
        <div class="card">
            <form action="" class="notify-form">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="<?php echo app('translator')->get('Email subject'); ?>"
                ...
                <div class="card-footer text-end">
                    <button type="submit" class="btn btn-global btn--primary me-2"><?php echo app('translator')->get('Send'); ?></button>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mt-3">
                    ...
                    <p><?php echo app('translator')->get('Email sent'); ?> <span class="sent">0</span> <?php echo app('translator')->get('users out of'); ?> <?php echo e($users); ?> <?php echo app('translator')->get('users'); ?>
                    </p>
                </div>
            </div>
        </div>
...
<span class="text--primary"><?php echo app('translator')->get('Notification will send via '); ?> <?php if($general->en): ?> <span
        class="badge badge--warning"><?php echo app('translator')->get('Email'); ?></span> <?php endif; ?> <?php if($general->sn): ?> <span
        class="badge badge--warning"><?php echo app('translator')->get('SMS'); ?></span> <?php endif; ?></span>
<?php $__env->stopPush(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\team-hifsa-skilset\application\resources\views\admin\instructors\notification_all.blade.php ENDPATH**/ ?>