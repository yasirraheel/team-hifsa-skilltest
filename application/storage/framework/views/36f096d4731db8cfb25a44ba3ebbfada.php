...
<?php $__env->startSection('content'); ?>
    <div class="row justify-content-center mx-lg-0">
        <div class="col-lg-12 justify-content-center">
            <div class="base--card">
                <div class="col-lg-12">
                    <form action="<?php echo e(route('instructor.question.store', $quiz->id)); ?>" method="POST"
                                        ...
                                        <div class="thumb">
                                            <div class="avatar-preview">
                                                <div class="profilePicPreview"
                                                    style="background-image: url(<?php echo e(getImage(getFilePath('quiz_question_image') . '/' . @$course->image)); ?>);">
                        ...
                        <div class="col-lg-12 text-end">
                            <button type="submit" class="btn btn--base" id="btn-save"><?php echo app('translator')->get('Save'); ?></button>
                        </div>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make($activeTemplate . 'instructor.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\team-hifsa-skilset\application\resources\views\presets\default\instructor\question\create.blade.php ENDPATH**/ ?>