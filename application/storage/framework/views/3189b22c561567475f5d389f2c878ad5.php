...
<?php $__env->startSection('content'); ?>
    <div class="row justify-content-center mx-lg-0">
        <div class="col-lg-12 justify-content-center">
            <div class="base--card">
                <div class="col-lg-12">
                    <form action="<?php echo e(route('instructor.course.update', $course->id)); ?>" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form--control" name="name" value="<?php echo e($course->name); ?>"
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form--control" type="number" name="price" value="<?php echo e($course->price); ?>"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form--control" type="number" name="discount"
                                        value="<?php echo e($course->discount); ?>" placeholder="Enter a discount" min="0">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-lg-6 mt-4">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form--control trumEdit" name="learn_description"><?php echo e($course->learn_description); ?></textarea>
                                </div>
                            </div>
                            <div class="col-lg-6 mt-4">
                                <div class="form-group mb-3">
                                    <label class=" mb-2"><?php echo app('translator')->get('Course Curriculum'); ?></label>
                                    <textarea class="form--control trumEdit" name="curriculum"><?php echo e($course->curriculum); ?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 mt-3">
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form--control trumEdit" name="description"><?php echo e($course->description); ?></textarea>
                            </div>
                        </div>
...
<?php echo $__env->make($activeTemplate . 'instructor.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\team-hifsa-skilset\application\resources\views\presets\default\instructor\course\edit.blade.php ENDPATH**/ ?>