...
<?php $__env->startSection('content'); ?>
    <div class="row justify-content-center mx-lg-0">
        <div class="col-lg-12 justify-content-center">
            <div class="base--card">
                <div class="col-lg-12">
                    <form action="<?php echo e(route('instructor.lesson.update', @$lesson->id)); ?>" method="POST"
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-3">
                                ...
                                <select class="form--control form-select" name="preview_video" id="preview_video" required>
                                    <option value="1"
                        ...
                        <div class="col-lg-12">
                            <div class="form-group mb-3">
                                ...
                                <div class="video-show pt-3 m-0 <?php echo e($lesson->upload_video ? '' : 'd-none'); ?>">
                                    <a href="javascript:void(0)" class="uploadVideoDelete text-end" onclick="modalShow();"><i
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p><?php echo app('translator')->get('Are you sure? you want change video URL?'); ?></p>
...
<?php $__env->startPush('script'); ?>
    ...
    <script type="text/javascript">
        ...
        let resumable = new Resumable({
            target: '<?php echo e(route('instructor.lesson.edit.video.upload')); ?>',
            query: {
    ...
    <script>
        ...
        function uploadeVideoDeleteAjax(ancor, srcValue, fileName, id) {
            $.ajax({
                url: "<?php echo e(route('instructor.lesson.edit.video.upload.delete')); ?>",
                type: "POST",
                data: {
                    videoUrl: srcValue,
                    fileName: fileName,
...
<?php echo $__env->make($activeTemplate . 'instructor.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\team-hifsa-skilset\application\resources\views\presets\default\instructor\lessons\edit.blade.php ENDPATH**/ ?>