            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-10 col-md-10 col-12">
                    <div class="account-form base--card mt-5">
                        ...
                        <form method="POST" action="<?php echo e(route('instructor.password.email')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="row gy-3">
                                <div class="col-sm-12">
...
<?php echo $__env->make($activeTemplate . 'layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\team-hifsa-skilset\application\resources\views\presets\default\instructor\auth\passwords\email.blade.php ENDPATH**/ ?>