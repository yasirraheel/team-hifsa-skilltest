                    ...
                    <?php if($user->kv == 2): ?>
                        <div class="d-flex flex-wrap justify-content-end mt-3">
                            <button class="btn btn--danger me-3 confirmationBtn" data-question="<?php echo app('translator')->get('Are you sure to reject this documents?'); ?>"
                                data-action="<?php echo e(route('admin.instructors.kyc.reject', $user->id)); ?>"><i
                            ...
                            <button class="btn btn--success confirmationBtn" data-question="<?php echo app('translator')->get('Are you sure to approve this documents?'); ?>"
                                data-action="<?php echo e(route('admin.instructors.kyc.approve', $user->id)); ?>"><i
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\team-hifsa-skilset\application\resources\views\admin\instructors\kyc_detail.blade.php ENDPATH**/ ?>