                ...
                <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6">
                    <div class="base-card">
                        ...
                        <div class="view-cta">
                            ...
                            <?php if((@$item->course->quizzes_count ?? 0) > 0): ?>
                                <a href="<?php echo e(route('user.quiz.courseQuiz', $item->course->id)); ?>"
...
<?php echo $__env->make($activeTemplate . 'layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\team-hifsa-skilset\application\resources\views\presets\default\user\enrolls\courses.blade.php ENDPATH**/ ?>