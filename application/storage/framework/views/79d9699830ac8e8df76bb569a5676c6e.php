                    ...
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light style--two custom-data-table">
                            ...
                            <tbody>
                                ...
                                <?php $__currentLoopData = $general->instructor_socialite_credentials ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $credential): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-end flex-wrap gap-1">
                                                ...
                                                <?php if(@$credential->status == 1): ?>
                                                    <button class="btn btn-outline--danger btn-sm confirmationBtn" data-question="<?php echo app('translator')->get('Are you sure that you want to enable this login credential?'); ?>" data-action="<?php echo e(route('admin.setting.instructor.socialite.credentials.status.update', $key)); ?>" title="Disabled"><i class="las la-ban"></i></button>
                                                <?php else: ?>
                                                    <button class="btn btn-outline--success btn-sm confirmationBtn" data-question="<?php echo app('translator')->get('Are you sure that you want to disable login credential?'); ?>" data-action="<?php echo e(route('admin.setting.instructor.socialite.credentials.status.update', $key)); ?>" title="Enabled"><i class="las la-check"></i></button>
                                                <?php endif; ?>
                                            </div>
                                        </td>
                                    </tr>
    ...
    <script>
        (function($) {
            ...
            $(document).on('click', '.editBtn', function() {
                let modal = $('#editModal');
                let data = $(this).data();
                let route = "<?php echo e(route('admin.setting.instructor.socialite.credentials.update', '')); ?>";
                let callbackUrl = "<?php echo e(route('instructor.social.login.callback', '')); ?>";
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\team-hifsa-skilset\application\resources\views\admin\setting\instructor_social_credential.blade.php ENDPATH**/ ?>