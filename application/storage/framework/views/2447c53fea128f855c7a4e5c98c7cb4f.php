                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a class="btn btn-sm btn--primary ms-1" title="Question Set"
                                                href="<?php echo e(route('admin.question.instructor', $item->id)); ?>">
                                                <i class="fa-solid fa-clipboard-question"></i></a>

                                            <a class="btn btn-sm btn--primary ms-1" title="Participants"
                                                href="<?php echo e(route('admin.quiz.instructor.participants', $item->id)); ?>">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\team-hifsa-skilset\application\resources\views\admin\quiz\instructor.blade.php ENDPATH**/ ?>