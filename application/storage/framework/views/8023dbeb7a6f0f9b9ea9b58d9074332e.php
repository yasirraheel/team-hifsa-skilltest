    ...
    <div class="row mx-lg-0 mb-3">
        <div class="col-lg-12">
            <div class="filter-wrap">
                ...
                <a href="<?php echo e(route('ticket.open')); ?>" class="btn btn--base">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $supports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $support): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td data-label="Subject" class="text-center">
                                    <a href="<?php echo e(route('ticket.view', $support->ticket)); ?>" class="fw-bold text-black">
                                ...
                                <td data-label="Action" class="text-center">
                                    <a class="btn btn--sm"
                                        href="<?php echo e(route('ticket.view', $support->ticket)); ?>"><?php echo app('translator')->get('View'); ?>
                                    </a>
                                </td>
                            </tr>
...
<?php echo $__env->make($activeTemplate . 'layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\team-hifsa-skilset\application\resources\views\presets\default\user\support\index.blade.php ENDPATH**/ ?>