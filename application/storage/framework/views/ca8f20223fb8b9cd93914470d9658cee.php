                    ...
                    <div class="col-sm-12">
                        <?php if(auth('instructor')->user()->ts): ?>
                            <div class="global-card">
                                ...
                                <form action="<?php echo e(route('instructor.twofactor.disable')); ?>" method="POST">
                                    <div class="card-body">
                                        <?php echo csrf_field(); ?>
                        ...
                        <?php else: ?>
                            <div class="base--card">
                                ...
                                <form action="<?php echo e(route('instructor.twofactor.enable')); ?>" method="POST">
                                    <div class="card-body">
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name="key" value="<?php echo e($secret); ?>">
                                        <div class="form-group">
...
<?php echo $__env->make($activeTemplate . 'instructor.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\team-hifsa-skilset\application\resources\views\presets\default\instructor\twofactor.blade.php ENDPATH**/ ?>