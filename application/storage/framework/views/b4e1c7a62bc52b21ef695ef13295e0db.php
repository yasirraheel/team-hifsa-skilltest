            ...
            <div class="row d-flex justify-content-center">
                <div class="verification-code-wrapper base--card mt-5">
                    <div class="verification-area">
                        ...
                        <form action="<?php echo e(route('instructor.go2fa.verify')); ?>" method="POST" class="submit-form">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make($activeTemplate . 'layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\team-hifsa-skilset\application\resources\views\presets\default\instructor\auth\authorization\2fa.blade.php ENDPATH**/ ?>