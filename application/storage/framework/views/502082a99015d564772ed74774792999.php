...
<button class="btn btn--primary" data-bs-toggle="modal" data-bs-target="#bugModal"><i class="las la-bug"></i>
  <?php echo app('translator')->get('Report a bug'); ?></button>
<a href="https://wstacks.com/support" target="_blank" class="btn btn--primary"><i class="las la-headset"></i>
  <?php echo app('translator')->get('Request for Support'); ?></a>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\team-hifsa-skilset\application\resources\views\admin\reports.blade.php ENDPATH**/ ?>