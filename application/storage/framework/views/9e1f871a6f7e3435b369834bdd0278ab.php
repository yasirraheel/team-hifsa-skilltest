                        ...
                        <div class="row">
                                    ...
                                    <div class="image-upload">
                                        <div class="thumb">
                                            ...
                                            <div class="avatar-edit">
                                                ...
                                                <label for="profilePicUpload1" class="bg--primary"><?php echo app('translator')->get('Upload
                                                                                                Image'); ?></label>
                                                <small class="mt-2"><?php echo app('translator')->get('Recomended size:'); ?>
                            ...
                            <div class="col-xl-8 mt-xl-0 mt-4">
                                <div class="form-group">
                                    ...
                                    <small class="ms-2 mt-2  "><?php echo app('translator')->get('Separate multiple keywords by'); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\team-hifsa-skilset\application\resources\views\admin\frontend\seo.blade.php ENDPATH**/ ?>