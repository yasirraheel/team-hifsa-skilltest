                            ...
                            <tr>
                                ...
                                <td>
                                    <button title="<?php echo app('translator')->get('Details'); ?>" class="btn btn-sm btn--primary notifyDetail"
                                        ...
                                        'email'): ?> data-message="<?php echo e(route('admin.instructor.report.email.details',$log->id)); ?>" <?php else: ?>
...
<?php if(@$user): ?>
<a href="<?php echo e(route('admin.instructors.notification.single',$user->id)); ?>" class="btn btn--primary btn-sm"><i
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\team-hifsa-skilset\application\resources\views\admin\instructors\reports\notification_history.blade.php ENDPATH**/ ?>