                    ...
                    <div class="row justify-content-between mt-3">
                        ...
                        <div class="col-md-5 mt-md-0 mt-3">
                            <button type="button" data-bs-toggle="modal" data-bs-target="#addModal"
                                class="btn btn-sm btn--primary float-end"><i class="fa fa-plus"></i> <?php echo app('translator')->get('Add
                                New Key'); ?> </button>
                        </div>
                    </div>
                    <hr>
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light tabstyle--two custom-data-table white-space-wrap" id="myTable">
                            ...
                            <tbody>
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $paginatedData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td class="white-space-wrap"><?php echo e($k); ?></td>
                                    <td class="text-left white-space-wrap"><?php echo e($language); ?></td>

                                    <td>
                                        <a title="<?php echo app('translator')->get('Edit'); ?>" href="javascript:void(0)" data-bs-target="#editModal"
                                            data-bs-toggle="modal" data-title="<?php echo e($k); ?>" data-key="<?php echo e($k); ?>"
                                            data-value="<?php echo e($language); ?>" class="editModal btn btn-sm btn--primary">
                                            <i class="la la-pencil"></i>
                                        </a>

                                        <a title="<?php echo app('translator')->get('Remove'); ?>" href="javascript:void(0)" data-key="<?php echo e($k); ?>"
                                            data-value="<?php echo e($language); ?>" data-bs-toggle="modal" data-bs-target="#DelModal"
                ...
                <form action="<?php echo e(route('admin.language.store.key',$lang->id)); ?>" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="value" name="value" value="<?php echo e(old('value')); ?>"
                                required>
...
<div class="modal fade" id="importModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="text-center text--danger"><?php echo app('translator')->get('If you import keywords, Your current keywords will be removed
                ...
                <div class="form-group">
                    <select class="form-control select_lang" required>
                        ...
                        <option value="<?php echo e($data->id); ?>" <?php if($data->id == $lang->id): ?> class="d-none" <?php endif; ?>
...
<button type="button" class="btn btn-sm btn--primary box--shadow1 importBtn"><i class="la la-download"></i><?php echo app('translator')->get('Import
    Keywords'); ?></button>
<?php $__env->stopPush(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\team-hifsa-skilset\application\resources\views\admin\language\edit_lang.blade.php ENDPATH**/ ?>