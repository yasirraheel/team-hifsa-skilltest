...
<?php $__env->startSection('content'); ?>
    <div class="mt-5 mx-4 <?php echo e(auth('instructor')->user() ? '' : 'mt-5'); ?>">
        <div class="row justify-content-center gy-4">
            <div class="<?php echo e(auth('instructor')->user() ? 'col-xl-12 col-lg-12' : 'col-lg-12 mt-4'); ?>">
                <div class="base--card">
                        ...
                        <div class="row gy-4">
                            <div class="col-md-12">
                                <div class="view-ticket-head d-flex justify-content-between">
                                    ...
                                    <?php if($myTicket->status != 3 && auth('instructor')->user()): ?>
                                        <button class="btn button bg--danger btn--sm btn-suuport confirmationBtn border-0"
                                            ...
                                            data-action="<?php echo e(route('instructor.ticket.close', $myTicket->id)); ?>"><i
                            ...
                            <?php if($myTicket->status != 4): ?>
                                <form method="post" action="<?php echo e(route('instructor.ticket.reply', $myTicket->id)); ?>"
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input--group textarea">
                                                <textarea id="message" class="form--control" name="message" placeholder="Please enter your Message"><?php echo e(old('message')); ?> </textarea>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <?php if($message->attachments->count() > 0): ?>
                                                            <div class="mt-2">
                                                                <?php $__currentLoopData = $message->attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <a href="<?php echo e(route('instructor.ticket.download', encrypt($image->id))); ?>"
                                                                        class="me-3"><i class="fa fa-file"></i>
                                                                        <?php echo app('translator')->get('Attachment'); ?> <?php echo e(++$k); ?> </a>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </div>
...
<?php echo $__env->make($activeTemplate . 'instructor.layouts.' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\team-hifsa-skilset\application\resources\views\presets\default\instructor\support\view.blade.php ENDPATH**/ ?>