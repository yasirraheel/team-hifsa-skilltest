...
<a href="<?php echo e(route('admin.profile')); ?>" class="btn btn-sm btn--primary"><i class="las la-user"></i><?php echo app('translator')->get('Profile
    Setting'); ?></a>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\team-hifsa-skilset\application\resources\views\admin\password.blade.php ENDPATH**/ ?>