            ...
            <div class="card-body">
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        ...
                        <span class="fw-bold"><?php echo e(showAmount($withdrawal->final_amount)); ?>
    ...
    <div class="col-lg-8 col-md-8 mb-30">
        ...
        <div class="card b-radius--10 overflow-hidden box--shadow1">
            <div class="card-body">
                ...
                <div class="row mt-4">
                    <div class="col-md-12">
                        <button class="btn btn--success ms-1 approveBtn" data-id="<?php echo e($withdrawal->id); ?>"
                            data-amount="<?php echo e(showAmount($withdrawal->final_amount)); ?> <?php echo e($withdrawal->currency); ?>">
                            <i class="fas la-check"></i> <?php echo app('translator')->get('Approve'); ?>
                        </button>

                        <button class="btn btn--danger ms-1 rejectBtn" data-id="<?php echo e($withdrawal->id); ?>">
        ...
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('admin.withdraw.approve')); ?>" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <textarea name="details" class="form-control pt-3" value="<?php echo e(old('details')); ?>" rows="3"
        ...
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('admin.withdraw.reject')); ?>" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <textarea name="details" class="form-control pt-3" rows="3" value="<?php echo e(old('details')); ?>"
                        required></textarea>
                </div>
                <div class="modal-footer">
                    <button type="submit" class="btn btn--primary btn-global"><?php echo app('translator')->get('Save'); ?></button>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\team-hifsa-skilset\application\resources\views\admin\withdraw\detail.blade.php ENDPATH**/ ?>