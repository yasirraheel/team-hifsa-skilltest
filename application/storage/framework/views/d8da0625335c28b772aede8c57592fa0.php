                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="currency" class="form-control border-radius-5"
                                                    value="<?php echo e($method->currency); ?>" required />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="rate"
                                                    value="<?php echo e(getAmount($method->rate)); ?>" required />
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="card border mb-2">
                                            <h5 class="card-header"><?php echo app('translator')->get('Withdrawal Limit'); ?></h5>
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label><?php echo app('translator')->get('Min'); ?></label>
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" name="min_limit"
                                                            value="<?php echo e(getAmount($method->min_limit)); ?>" required />
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" name="max_limit"
                                                            value="<?php echo e(getAmount($method->max_limit)); ?>" required />
                                                        <span class="input-group-text bg--primary"> <?php echo e(__($general->cur_text)); ?> </span>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" name="fixed_charge"
                                                            value="<?php echo e(getAmount($method->fixed_charge)); ?>" required />
                                                        <span class="input-group-text bg--primary"> <?php echo e(__($general->cur_text)); ?> </span>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" name="percent_charge"
                                                            value="<?php echo e(getAmount($method->percent_charge)); ?>" required>
...
<a href="<?php echo e(route('admin.withdraw.method.index')); ?>" class="btn btn-sm btn--primary"><?php echo app('translator')->get('Back'); ?>
</a>
<?php $__env->stopPush(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\team-hifsa-skilset\application\resources\views\admin\withdraw\edit.blade.php ENDPATH**/ ?>