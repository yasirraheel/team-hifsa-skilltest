                    ...
                    <div class="card p-2">
                        <ul class="d-flex flex-wrap gap-1">
                            ...
                            <li class="flex-grow-1 flex-shrink-0">
                                <a class="d-block btn bg--primary" href="<?php echo e(route('admin.users.login',$user->id)); ?>"
                                    target="_blank">
                            ...
                            <li class="flex-grow-1 flex-shrink-0">
                                <a class="d-block btn bg--primary"
                                    href="<?php echo e(route('admin.users.notification.log',$user->id)); ?>">
                            ...
                            <li class="flex-grow-1 flex-shrink-0">
                                ...
                                <a class="d-block btn bg--primary" class="userStatus" data-bs-toggle="modal"
                                    ...
                                    <i class="las la-ban"></i> <?php echo app('translator')->get('Ban Student'); ?>
                                </a>
                                <?php else: ?>
                                <a class="userStatus bg--primary" data-bs-toggle="modal"
                                    data-bs-target="#userStatusModal" href="javascript:void(0)">
                                    <i class="las la-undo"></i> <?php echo app('translator')->get('Unban Student'); ?>
                                </a>
                                <?php endif; ?>
                            </li>
                            <li class="flex-grow-1 flex-shrink-0">
                                <a class="d-block btn bg--primary"
                                    href="<?php echo e(route('admin.users.notification.single', $user->id)); ?>">
                            ...
                            <div class="row">
                                <div class="form-group  col-xl-3 col-md-6 col-12">
                                    ...
                                    <label class="switch m-0">
                                        <input type="checkbox" class="toggle-switch" name="ev" <?php echo e($user->ev ?
                                        'checked' : null); ?>>
                                ...
                                <div class="form-group  col-xl-3 col-md-6 col-12">
                                    ...
                                    <label class="switch m-0">
                                        <input type="checkbox" class="toggle-switch" name="sv" <?php echo e($user->sv ?
                                        'checked' : null); ?>>
                                        <span class="slider round"></span>
                                    </label>
                                </div>
                                <div class="form-group  col-xl-3 col-md-6 col-12">
                                    ...
                                    <label class="switch m-0">
                                        <input type="checkbox" class="toggle-switch" name="ts" <?php echo e($user->ts ?
                                        'checked' : null); ?>>
                                        <span class="slider round"></span>
                                    </label>
                                </div>
                                <div class="form-group  col-xl-3 col-md-6 col-12">
                                    ...
                                    <label class="switch m-0">
                                        <input type="checkbox" class="toggle-switch" name="kv" <?php echo e($user->kv ?
                                        'checked' : null); ?>>
                                        <span class="slider round"></span>
                                    </label>
                                </div>
            ...
            <form action="<?php echo e(route('admin.users.add.sub.balance',$user->id)); ?>" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" placeholder="<?php echo app('translator')->get('Remark'); ?>" name="remark" rows="4"
                            required></textarea>
                    </div>
                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\team-hifsa-skilset\application\resources\views\admin\users\detail.blade.php ENDPATH**/ ?>