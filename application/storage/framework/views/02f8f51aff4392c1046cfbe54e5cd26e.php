                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form--control form-select" name="pricing_type" id="pricingType" required>
                                            <option value="paid" <?php if(old('pricing_type', ($course->price > 0 ? 'paid' : 'free')) === 'paid'): echo 'selected'; endif; ?>><?php echo app('translator')->get('Paid'); ?></option>
                                            <option value="free" <?php if(old('pricing_type', ($course->price > 0 ? 'paid' : 'free')) === 'free'): echo 'selected'; endif; ?>><?php echo app('translator')->get('Free'); ?></option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-6">
