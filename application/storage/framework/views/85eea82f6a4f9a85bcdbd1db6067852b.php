...
<body class="mt-4">
    ...
    <div class="row justify-content-center d-flex mt-5">
        <button class="btn btn--base btn--sm w-25 download" type="button" id="demo"><?php echo app('translator')->get('Download'); ?></button>
    </div>


    <script src="<?php echo e(asset('assets/common/js/jquery-3.7.1.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/admin/js/html2pdf.bundle.min.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\team-hifsa-skilset\application\resources\views\presets\default\user\quiz\certificate.blade.php ENDPATH**/ ?>