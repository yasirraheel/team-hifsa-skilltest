    ...
    <div class="col-lg-3">
        <div class="card">
            ...
            <div class="card-footer text-end">
                <a href="<?php echo e($temp['url']); ?>" target="_blank" class="btn btn--primary"><?php echo app('translator')->get('Get This'); ?></a>
            </div>
        </div>
    </div>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\team-hifsa-skilset\application\resources\views\admin\frontend\templates.blade.php ENDPATH**/ ?>