...
<?php $__env->startSection('panel'); ?>
    <div class="row">
        <?php echo $__env->make('admin.components.tabs.quiz', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <div class="col-lg-12">
            <div class="card b-radius--10 ">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-sm btn--primary ms-1"
                                                href="<?php echo e(route('admin.quiz.edit', $item->id)); ?>">
                                                <i class="la la-pen"></i></a>
                                            <a class="btn btn-sm btn--primary ms-1" title="Question Set"
                                                href="<?php echo e(route('admin.question.index', $item->id)); ?>">
                                                <i class="fa-solid fa-clipboard-question"></i></a>
                                            <a class="btn btn-sm btn--primary ms-1" title="Participant"
                                                href="<?php echo e(route('admin.quiz.participants', $item->id)); ?>">
                                                <i class="fa-solid fa-people-group"></i></a>
                                            <a class="btn btn-sm btn--danger ms-1" href="javascript:void(0)"
                                                data-url="<?php echo e(route('admin.quiz.delete', @$item->id)); ?>"
                ...
                <?php if($quizzes->hasPages()): ?>
                    <div class="card-footer py-4">
                        <?php echo paginateLinks($quizzes) ?>
                    </div>
                <?php endif; ?>
            </div><!-- card end -->
        </div>
...
<?php $__env->startPush('breadcrumb-plugins'); ?>
    <div class="d-flex flex-wrap justify-content-end align-items-center">
        <a href="<?php echo e(route('admin.quiz.create')); ?>" class="btn btn-sm btn--primary create_course_category me-3"><i
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\team-hifsa-skilset\application\resources\views\admin\quiz\index.blade.php ENDPATH**/ ?>