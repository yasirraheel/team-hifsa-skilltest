                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $quizUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <?php echo e(@$item->correctMarking(@$item->quiz?->id, @$item->user?->id)); ?>/<?php echo e(__(@$item->quiz?->pass_mark)); ?>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn--danger btn-sm" href="javascript:void(0)"
                                                data-url="<?php echo e(route('admin.quiz.participant.delete', [$item->quiz?->id, $item->user?->id])); ?>"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\team-hifsa-skilset\application\resources\views\admin\quiz\participants.blade.php ENDPATH**/ ?>