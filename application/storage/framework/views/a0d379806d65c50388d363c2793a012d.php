                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a title="<?php echo app('translator')->get('Edit'); ?>"
                                                    href="<?php echo e(route('admin.gateway.manual.edit', $gateway->alias)); ?>"
                                                ...
                                                <?php if($gateway->status == 0): ?>
                                                    <button title="<?php echo app('translator')->get('Enable'); ?>"
                                                        class="btn btn-sm btn--success confirmationBtn"
                                                        data-question="<?php echo app('translator')->get('Are you sure to enable this gateway?'); ?>"
                                                        data-action="<?php echo e(route('admin.gateway.manual.activate', $gateway->code)); ?>">
                                                ...
                                                <?php else: ?>
                                                    <button title="<?php echo app('translator')->get('Disable'); ?>"
                                                        ...
                                                        data-action="<?php echo e(route('admin.gateway.manual.deactivate', $gateway->code)); ?>">
...
<?php $__env->startPush('breadcrumb-plugins'); ?>
    <div class="d-flex flex-wrap justify-content-end">
        <a class="btn btn--primary me-2 d-flex align-items-center" href="<?php echo e(route('admin.gateway.manual.create')); ?>"><i
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\team-hifsa-skilset\application\resources\views\admin\gateways\manual\list.blade.php ENDPATH**/ ?>