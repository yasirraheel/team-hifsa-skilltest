                                ...
                                <div class="drop-file-wrap--">
                                    <div class="dashboard_profile_wrap">
                                        ...
                                        <div class="user-info text-center">
                                            <p><span><?php echo app('translator')->get('User Name'); ?>:</span><?php echo e(auth()->user()->fullname ?? auth()->user()->username); ?>

                                            </p>
                                            <p><span><?php echo app('translator')->get('Email'); ?>:</span><?php echo e(auth()->user()->email); ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make($activeTemplate . 'layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\team-hifsa-skilset\application\resources\views\presets\default\user\profile_setting.blade.php ENDPATH**/ ?>