    ...
    <div class="row mb-none-30 justify-content-center">
        <div class="col-xl-4 col-md-6 mb-30">
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body">
                    <h5 class="mb-20 text-muted"><?php echo app('translator')->get('Payments Via'); ?> <?php echo e(__(@$deposit->gateway->name)); ?></h5>
                    <ul class="list-group">
        ...
        <?php if($details || $deposit->status == 2): ?>
            <div class="col-xl-8 col-md-6 mb-30">
                <div class="card b-radius--10 overflow-hidden box--shadow1">
                    <div class="card-body">
                        <h5 class="card-title mb-50 border-bottom pb-2"><?php echo app('translator')->get('Payments Info'); ?></h5>
                        <?php if($details != null): ?>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    <button class="btn btn--success ms-1 confirmationBtn"
                                        ...
                                        data-question="<?php echo app('translator')->get('Are you sure to approve this transaction?'); ?>"><i class="fas fa-check"></i>
                                        <?php echo app('translator')->get('Approve'); ?>
                                    </button>

                                    <button class="btn btn--danger ms-1 rejectBtn" data-id="<?php echo e($deposit->id); ?>"
                                        data-info="<?php echo e($details); ?>"
                                        data-amount="<?php echo e(showAmount($deposit->amount)); ?> <?php echo e(__($general->cur_text)); ?>"
                                        data-username="<?php echo e(@$deposit->user->username); ?>"><i class="fas fa-ban"></i>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo app('translator')->get('Reject Payments Confirmation'); ?></h5>
                ...
                <form action="<?php echo e(route('admin.deposit.reject')); ?>" method="POST">
                    ...
                    <div class="modal-body">
                        <p><?php echo app('translator')->get('Are you sure to'); ?> <span class="fw-bold"><?php echo app('translator')->get('reject'); ?></span> <span
                                class="fw-bold withdraw-amount text-success"></span> <?php echo app('translator')->get('payment of'); ?> <span
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\team-hifsa-skilset\application\resources\views/admin/deposit/detail.blade.php ENDPATH**/ ?>